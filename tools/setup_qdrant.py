    ...
    def _setup_payload_indexes(self) -> bool:
        ...
        try:
            ...
            indexes_config = [
                ...
                ("cost_monitoring.monthly_tracking.monthly_budget_status", PayloadSchemaType.KEYWORD),
    ...
    def test_schema_v330_operations(self) -> bool:
        ...
        try:
            ...
            if search_results.points:
                ...
                expected_keys = {
                    "session_id", "timestamp", "content", "ai_models", 
                    "clinical_assessment", "rag_metadata", "narrative_insight",
                    "clinical_classification", "cost_monitoring", "system_metadata"
                }
