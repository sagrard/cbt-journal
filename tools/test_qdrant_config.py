...
class QdrantDefaultConfigTest:
    ...
    def test_performance_baseline(self) -> Dict[str, float]:
        ...
        try:
            ...
            if not any(col.name == self.collection_name 
            ...
            print(f"✅ Insert 10 points: {insert_time:.3f}s ({insert_time/10*1000:.1f}ms per point)")
    ...
    def test_concurrent_operations(self) -> bool:
        ...
        try:
            ...
            if cleanup_points[0]:
                ...
                self.client.delete(collection_name=self.collection_name, points_selector=cleanup_ids)
