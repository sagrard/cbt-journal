...
class CostControlCLI:
    ...
    def check_budget(self, session_id: str, tokens_input: int, tokens_output: int, 
                    model: str = "gpt-4o-2024-11-20") -> None:
        ...
        if any([alerts['session_over_budget'], alerts['daily_approaching_limit'], 
               alerts['monthly_approaching_limit'], alerts['unusual_cost_spike']]):
            print(f"\n⚠️  ALERTS:")
    ...
    def record_cost(self, session_id: str, api_type: str, model: str, 
    ...
    def estimate_cost(self, tokens_input: int, tokens_output: int, 
                     model: str = "gpt-4o-2024-11-20") -> None:
    ...
    def set_limits(self, session_limit: float = None, daily_limit: float = None, 
    ...
    def show_alerts(self) -> None:
        ...
        for timestamp, alert_type, severity, message in alerts:
            ...
            # Emoji per severity
            emoji = {"ERROR": "🚨", "CRITICAL": "💥", "WARNING": "⚠️", "INFO": "ℹ️"}.get(severity, "📝")
...
Examples:
  ...
  python cost_control_cli.py alerts
    ...
    summary_parser.add_argument('--period', choices=['today', 'month'], default='today', help='Period')
    ...
    test_parser.add_argument('--scenario', choices=['light', 'normal', 'heavy', 'mini'], 
                           required=True, help='Test scenario')
    ...
    try:
        if args.command == 'check':
            ...
            cli.record_cost(args.session, args.type, args.model, 
                          args.input, args.output, args.cost, args.purpose)
